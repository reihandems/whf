<div class="drawer lg:drawer-open shadow-lg shadow-gray-500/50">
    ...
    <div class="drawer-side">
        ...
        <ul class="menu bg-base-200 min-h-full w-80 p-4">
            ...
            <li>
                <a href="#" class="flex flex-row items-center gap-2 my-1 p-3 <?= ($menu == 'dashboard') ? 'bg-base-300 text-primary-500 font-bold' : 'text-gray-400' ?>" </a>
            ...
            <li>
                <a href="#" class="flex flex-row items-center gap-2 my-1 p-3 <?= ($menu == 'produk') ? 'bg-base-300 text-primary-500 font-bold' : 'text-gray-400' ?>" </a>
            ...
            <li>
                <a href="#" class="flex flex-row items-center gap-2 my-1 p-3 <?= ($menu == 'customer') ? 'bg-base-300 text-primary-500 font-bold' : 'text-gray-400' ?>" </a>
            ...
            <li>
                <a href="#" class="flex flex-row items-center gap-2 my-1 p-3 <?= ($menu == 'trainer') ? 'bg-base-300 text-primary-500 font-bold' : 'text-gray-400' ?>" </a>
            ...
            <li>
                <a href="#" class="flex flex-row items-center gap-2 my-1 p-3 <?= ($menu == 'supplier') ? 'bg-base-300 text-primary-500 font-bold' : 'text-gray-400' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
