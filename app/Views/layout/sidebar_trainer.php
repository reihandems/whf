<div class="drawer lg:drawer-open shadow-lg shadow-gray-500/50">
    ...
    <div class="drawer-side">
        ...
        <ul class="menu bg-base-200 min-h-full w-80 p-4">
            ...
            <li>
                <div class="flex flex-row items-center gap-2 my-1">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-sm text-gray-400">Trainer</span>
                    </div>
                </div>
            </li>
            <div class="divider my-1"></div>
            <li>
                <a href="<?= base_url('/trainer/dashboard') ?>" class="flex flex-row items-center gap-2 my-1 p-3 <?= ($menu == 'dashboard') ? 'bg-base-300 text-primary-500 font-bold' : 'text-gray-400' ?>" </a>
            ...
            <li>
                <a href="<?= base_url('/trainer/booking') ?>" class="flex flex-row items-center gap-2 my-1 p-3 <?= ($menu == 'booking') ? 'bg-base-300 text-primary-500 font-bold' : 'text-gray-400' ?>" </a>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
